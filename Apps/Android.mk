...
LOCAL_MODULE := Lspeed
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := Lspeed/Lspeed.apk
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE := Forest
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := Forest/Forest.apk
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := DocScanner
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := DocScanner/DocScanner.apk
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := BarCode/BarCode.apk
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
