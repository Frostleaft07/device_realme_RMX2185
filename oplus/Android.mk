...
LOCAL_OVERRIDES_PACKAGES := Launcher3 Launcher3QuickStep Launcher2 PixelLauncher TrebuchetQuickStep NexusLauncherPrebuilt NexusLauncherRelease Trebuchet
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := OPScreenRecorders
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := OPScreenRecorders/OPScreenRecorders.apk
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_OVERRIDES_PACKAGES := OPScreenRecorder
include $(BUILD_PREBUILT)
